...
void Seeds::runAll() {
    ...
    Animal("Timothy", "Dog", "male", "Yorkshire Terrier", 1, false, true, "brown", false).create();
    Animal("Holly", "Dog", "female", "Labrador Retriever", 10, false, true, "yellow", false).create();
    Animal("Whiskers", "Cat", "male", "Tabby", 6, false, false, "orange", false).create();
    Animal("Salem", "Cat", "female", "American Shorthair", 11, false, true, "black", false).create();
    Animal("Bugs", "Rabbit", "male", "Britannia Petite", 3, true, false, "grey", false).create();

    Animal("Charles", "Dog", "male", "Husky", 8, false, false, "grey", false).create();
    Animal("Jamie", "Dog", "female", "German Shepherd", 15, false, false, "yellow", false).create();
    Animal("Patrick", "Cat", "male", "Russian Blue", 2, true, false, "grey", false).create();
    Animal("Nibbles", "Cat", "female", "Persian", 13, false, false, "white", false).create();
    Animal("Pickles", "Rabbit", "male", "Dutch", 2, true, true, "grey", false).create();

    Animal("Spot", "Dog", "male", "Dalmation", 1, true, true, "black and white", false).create();
    Animal("Ivy", "Dog", "female", "Pug", 2, false, true, "black", false).create();
    Animal("Bill", "Cat", "male", "Siamese", 14, true, false, "beige", false).create();
    Animal("Caroline", "Cat", "female", "Scottish Fold", 8, true, false, "brown", false).create();
    Animal("BoJack", "Rabbit", "male", "Dwarf Hotot", 16, false, false, "brown", false).create();

    Animal("Harold", "Dog", "male", "Chihuahua", 2, true, false, "white", false).create();
    Animal("Nadeen", "Dog", "female", "Shih Tzu", 4, false, true, "brown and white", false).create();
    Animal("Dirk", "Cat", "male", "British Shorthair", 5, false, false, "yellow", false).create();
    Animal("Alexandra", "Cat", "female", "Sphynx", 13, true, true, "pink", false).create();
    Animal("Sunny", "Rabbit", "male", "Himalayan", 9, true, false, "white", false).create();

    Animal("Pearl", "Dog", "male", "Greyhound", 1, false, true, "grey", false).create();
    Animal("Carol", "Dog", "female", "Cocker Spaniel", 3, false, false, "yellow", false).create();
    Animal("Floyd", "Cat", "male", "Tabby", 14, false, true, "orange", false).create();
    Animal("Hayley", "Cat", "female", "American Shorthair", 4, true, false, "white", false).create();
    Animal("Reese", "Rabbit", "male", "Holland Lop", 4, false, true, "grey", false).create();

    Animal("Angie", "Dog", "female", "Poodle", 1, false, true, "grey", false).create();
    Animal("Angel", "Rabbit", "female", "Dwarf", 3, true, true, "brown", false).create();
    Animal("Boo", "Cat", "male", "Tabby", 10, true, true, "orange", false).create();
    Animal("Ghost", "Dog", "male", "Pug", 15, true, false, "black", false).create();
    Animal("Fluffy", "Rabbit", "female", "Holland Lop", 4, true, false, "grey", false).create();
    ...
    Client(1, 24, "613-928-5235", "johnny@cuacs.ca", 100, true, true, 80000, 1, true).create();
    Client(2, 19, "613-413-5276", "niko.kouloufakos@shopify.com", 80, false, false, 60000, 4, false).create();
    Client(3, 42, "613-765-9265", "william@wildfox.ca", 400, true, false, 50000, 6, false).create();
    Client(4, 34, "613-067-8564", "lulusheng@cmail.carleton.ca", 700, false, false, 60000, 5, true).create();
    Client(5, 64, "613-341-0696", "lukas@gmail.com", 1200, false, false, 50000, 4, false).create();

    Client(6, 29, "613-432-5252", "ladygaga@hotmail.com", 1500, true, true, 200000, 4, true).create();
    Client(7, 39, "613-413-5555", "radcliffeD@gmail.com", 1600, false, false, 200000, 3, false).create();
    Client(8, 54, "613-765-9482", "prince@james.ca", 2000, true, true, 40000, 5, false).create();
    Client(9, 19, "613-493-8564", "theDagger@cmail.carleton.ca", 300, false, true, 40000, 2, true).create();
    Client(10, 22, "613-341-3248", "yukelang@gmail.com", 400, true, true, 75000, 1, false).create();

    Client(11, 24, "613-392-5235", "mccarthy@shopify.ca", 1000, true, true, 150000, 6, true).create();
    Client(12, 45, "613-413-3928", "wyattTheFish@shopify.com", 200, true, false, 120000, 7, false).create();
    Client(13, 55, "613-444-9265", "melanie.smith@gmail.ca", 1600, false, false, 40000, 4, false).create();
    Client(14, 50, "613-067-0000", "jessicaJJ@cmail.carleton.ca", 100, false, false, 60000, 1, true).create();
    Client(15, 28, "613-341-9282", "gordon.matt@gmail.com", 2000, false, false, 320000, 4, false).create();

    Client(16, 31, "613-324-9485", "middleton@cuacs.ca", 1300, true, true, 500000, 1, true).create();
    Client(17, 35, "613-098-5845", "Tina.zhang123@shopify.com", 800, true, true, 30000, 5, false).create();
    Client(18, 41, "613-492-0003", "jaqueline432@wildfox.ca", 900, false, false, 20000, 6, false).create();
    Client(19, 47, "613-067-3847", "emily.wong983@cmail.carleton.ca", 200, false, false, 10000, 7, true).create();
    ...
    Client(23, 23, "613-111-9265", "rocky123@wildfox.ca", 200, false, false, 80000, 1, false).create();
    Client(24, 22, "613-067-9583", "grace.smith@cmail.carleton.ca", 200, true, true, 120000, 2, true).create();
    Client(25, 22, "613-341-2332", "boringJohnSmith@gmail.com", 1450, true, false, 60000, 1, false).create();
